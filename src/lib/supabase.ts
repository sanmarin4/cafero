...
// the project template sometimes uses VITE_SUPABASE_PUBLISHABLE_DEFAULT_KEY instead
...
if (!supabaseUrl || !supabaseAnonKey) {
  ...
  console.warn('Expected VITE_SUPABASE_ANON_KEY or VITE_SUPABASE_PUBLISHABLE_DEFAULT_KEY');
}
